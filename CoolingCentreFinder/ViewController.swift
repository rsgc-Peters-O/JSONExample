...
class ViewController : UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    var phoneNumber = UITextView(frame: CGRect(x: 0, y: 0, width: 300.0, height: 300.0))
    var address = UITextView(frame: CGRect(x: 0, y: 0, width: 300.0, height: 300.0))
    ...
    func currentLocationDistanceTo(otherLatitude : Double, otherLongitude : Double) -> Double {
    ...
    func parseMyJSON(_ theData : Data) {
        ...
        do {
            ...
            //
            let allCoolingCentres = try JSONSerialization.jsonObject(with: theData, options: JSONSerialization.ReadingOptions.allowFragments) as! [AnyObject]
    ...
    override func viewDidLoad() {
        ...
        appTitle.font = UIFont.systemFont(ofSize: 48)
        ...
        preamble.font = UIFont.systemFont(ofSize: 24)
        ...
        // Set the label text and appearance
        stationName.font = UIFont.systemFont(ofSize: 18)
        stationName.text = "loading"
        stationName.textColor = UIColor.gray
         ...
         */
        let mapContainer : UIView = UIView(frame: CGRect(x: 0, y: 0, width: 640, height: 350))
        mapContainer.translatesAutoresizingMaskIntoConstraints = false
        map = MKMapView(frame: CGRect(x: 0, y: 0, width: 640, height: 350))
        ...
        // Set the label text and appearance
        jsonResult.text = ""
        jsonResult.font = UIFont.systemFont(ofSize: 12)
        ...
        let verticalConstraints = NSLayoutConstraint.constraints(
            withVisualFormat: "V:|-30-[title]-10-[preamble]-15-[name]-[address][phone]-20-[theMap]-[result]",
            options: [],
            metrics: nil,
